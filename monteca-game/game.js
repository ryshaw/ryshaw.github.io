const VERSION = "Monteca Game v0.1";
...
const COLORS = {
  topGradient: 0xcae5ff, // for background
  bottomGradient: 0x594382, // for background
...
class Game extends Phaser.Scene {
  ...
  preload() {
    this.load.image("norma", "assets/norma.png");
  ...
  createLayout() {
    ...
    const rect = this.add
      ...
      .setStrokeStyle(12, 0xcae5ff, 0.95);
  }

  createText() {
    const name = new GameText(
      this,
      gameW * 0.38,
      gameH * 0.58,
      "Norma Leon",
    ...
    const msg =
      "There's no way. I don't believe it.\nRyan can't possibly be dead.\nHe's down there... somewhere. In the sea.";

    const dialog = new GameText(this, gameW * 0.57, gameH * 0.73, msg, 3)
      .setAlign("left")
