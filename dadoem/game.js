class Game extends Phaser.Scene {
  ...
  createLayout() {
    ...
    this.add
      ...
      .preFX.addGradient(0x023e8a, 0x457b9d, 0.08, num1, num1, num2, num2, 24);
  }

  loadGameUI() {
    this.add
      .image(this.w * 0.69, this.h * 0.54, "discord")
      .setScale(0.18)
      .setAlpha(0.5);
    //.setTint(0x000ff);
    ...
    new CustomText(
      ...
      this.w * 0.04,
      this.h * 0.2,
      "join for talking about:\n  art, comics, games, books, tv\n  memes\n  Garfield Monday\n  Fishin' Friday\n  #ENERGYSWORDSUNDAY",
      "g",
      "l"
    )
      .setFontSize("48px")
      .setOrigin(0, 0)
      .setLineSpacing(32)
      .postFX.addGlow(0xffffff, glow);

    new CustomText(
      this,
      this.w * 0.96,
      this.h * 0.88,
      "discord.gg/P7EDYSvg9X",
      "g",
      "r"
    )
      .setFontSize("80px")
